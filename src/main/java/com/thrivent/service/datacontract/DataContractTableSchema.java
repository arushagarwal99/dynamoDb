...
public class DataContractTableSchema extends TableSchemaBuilder<DataContract, ImmutableDataContract.Builder> {
    ...
    private ImmutableAttribute<DataContract, ImmutableDataContract.Builder, Long> version() {
        return attribute(Long.class)
                .addTag(StaticAttributeTags.atomicCounter(1,1))
                .name("version")
                .getter(DataContract::version)
                .setter(ImmutableDataContract.Builder::version)
                .build();
    }
