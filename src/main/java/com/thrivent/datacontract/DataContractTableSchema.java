...
import com.thrivent.task.TaskDataTableSchema;
...
public class DataContractTableSchema extends TableSchemaBuilder<DataContract, ImmutableDataContract.Builder> {
    ...
    private ImmutableAttribute<DataContract, ImmutableDataContract.Builder, List<TaskData>> task() {
        return attribute(EnhancedType.listOf( EnhancedType.documentOf( TaskData.class, taskDataTableSchema)))
                .name("task")
                .getter(DataContract::task)
                .setter(ImmutableDataContract.Builder::task)
                .build();
    }
}
